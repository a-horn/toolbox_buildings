...
for more details).\footnote{For insulation material we consulted summaries of a 
related [business study](https://ceresana.com/produkt/marktstudie-daemmstoffe-welt)
to provide as a yard stick for allocating costs related to insulation material.}
...
io_results <- data.frame(year = start_year:end_year,
                         ...
                         growth_employment_construction = 
                           t(sector_impact_employment[
                             rownames(sector_impact_employment) %in% 
                            c("Specialised.construction.works"), ]),
                         ...
                         rename(growth_employment_construction=
